...
public class ExampleController {
	...
	public String ex1(HttpServletRequest req, Model model) {
		...
		// 단일 값(숫자, 문자얄_ Model을 이용해서 html로 전달
		...
		stdList.add(new Student("11111","짱구",21));
		stdList.add(new Student("22222","철수",24));
		stdList.add(new Student("33333","유리",23));

...
public class FileConfig implements WebMvcConfigurer {
	...
	public void addResourceHandlers(ResourceHandlerRegistry registry) {
		...
		// 서버 폴더 경로 중 C:/uploadFiles/test/로 연결하겠다(여기서 이미지를 찾겠다)
	...
	public MultipartConfigElement configElement() {
		...
		// 파일 업로드를 처리하는데 사용되는 MultipartConfigElemnet를 구성하고 반환
		...
		// 개별 파일당 최대 크기
		factory.setMaxFileSize(DataSize.ofBytes(mazFileSize));
